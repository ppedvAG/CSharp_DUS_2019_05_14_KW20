...
namespace ExceptionHandling
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Du hast keine Zahl eingegeben. " + ex.Message);
            }
            catch(OverflowException ex)
            {
                Console.WriteLine("Du hast eine zu große/kleine Zahl eingegeben. " +ex.Message);
            }
            ...
            Console.WriteLine("Try/Catch-Ende");
